...
# Route knowledge-base uploads, RFP uploads, and the company profile file
# to a throwaway directory instead of the repo's real (empty-by-default)
# data/ folder — tests that upload documents must never leave files behind
# in the actual project directory.
os.environ.setdefault("DATA_DIR", tempfile.mkdtemp(prefix="bidfactory-test-data-"))
