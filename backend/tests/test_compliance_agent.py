...
def test_confirms_supported_claim():
    evidence = [{"source": "doc.md", "text": "The vendor maintains ISO 27001 certification.", "score": 0.5}]
...
def test_partial_when_relevant_evidence_does_not_confirm_exact_term():
    evidence = [{"source": "doc.md", "text": "The vendor provides enterprise cloud services with strong support.", "score": 0.2}]
...
def test_non_exact_term_requirement_passes_on_any_evidence():
    evidence = [{"source": "doc.md", "text": "The vendor supports REST APIs with OAuth 2.0.", "score": 0.3}]
